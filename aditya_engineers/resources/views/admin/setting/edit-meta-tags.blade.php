            ...
            <div class="card-body">
               <form action="{{route('metatags.update',['metatag' => $meta_tags->id])}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row gx-3">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Author </label>
                           <input type="text" class="form-control " name="author" placeholder="Enter author" value="{{$meta_tags->author}}">
                           @error('author')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Canonical</label>
                           <input type="text" class="form-control " name="canonical" placeholder="Enter canonical" value="{{$meta_tags->canonical}}">
                           @error('canonical')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Og Image Width</label>
                           <input type="number" class="form-control " name="width" placeholder="Enter width" value="{{$meta_tags->width}}">
                           @error('width')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Og Image Height</label>
                           <input type="number" class="form-control " name="height" placeholder="Enter height" value="{{$meta_tags->height}}">
                           @error('height')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
