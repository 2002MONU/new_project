                        ...
                        <form action="{{ route('galleries.update', $gallery->id) }}" method="POST"
                            ...
                            <div class="row gx-3">
                                <div class="col-xxl-6 col-lg-6 col-sm-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="design_name">Title <span class="text-danger">*
                                            </span></label>
                                ...
                                <div class="col-xxl-6 col-lg-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="priority"
                                            placeholder="Enter priority" value="{{ old('priority', $gallery->priority) }}">
                                        @error('priority')
                                            <div class="error text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-6 col-lg-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="status" class="form-control">
                                            <option value="1"
                                                {{ old('status', $gallery->status) == 1 ? 'selected' : '' }}>Active
                                            </option>
                                            <option value="0"
                                                {{ old('status', $gallery->status) == 0 ? 'selected' : '' }}>Inactive
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="error text-danger">{{ $message }}</div>
