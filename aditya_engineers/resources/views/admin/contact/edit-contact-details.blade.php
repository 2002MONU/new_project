            ...
            <div class="card-body">
               <form action="{{route('contact-details.update',['contact_detail'=>$contact->id])}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row gx-3">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Linkedin_user <span class="text-danger">*</span> </label>
                           <input type="text" class="form-control"   name="linkedin_user" placeholder="Enter linkedin_user " value="{{$contact->linkedin_user}}"> 
                           @error('linkedin_user')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-12">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="url" class="form-control"  name="youtube" placeholder="Enter youtube link " value="{{$contact->youtube}}">
                           @error('youtube')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="url" class="form-control" rows="6"  name="map_link" placeholder="Enter map_link " value="">{{$contact->map_link}}</textarea>
                           @error('map_link')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
