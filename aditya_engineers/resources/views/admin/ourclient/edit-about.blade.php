   ...
   <div class="row gx-3">
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <form action="{{route('our-client-abouts.update',$about->id)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <!-- Row starts -->
                  <div class="row gx-3">
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                      ...
                      <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Images  </label>
                           <input type="file" id="fileInput1" class="form-control file-input" name="images[]" multiple  >
                           <span> ( Note:IMG TYPE:- JPEG,PNG,JPG,WEBP,You can select multiple image)</span><br>
