               ...
               <form action="{{route('slider-videos.update',['slider_video'=>$slider->id])}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row gx-3">
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-12">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Text 1 <span class="text-danger">*</span> </label>
                           <input type="text" class="form-control "   name="text1" placeholder="Enter title " value="{{$slider->text1}}"> 
                           @error('text1')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Text 2 <span class="text-danger">*</span> </label>
                           <input type="text" class="form-control "   name="text2" placeholder="Enter title " value="{{$slider->text2}}"> 
                           @error('text2')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
