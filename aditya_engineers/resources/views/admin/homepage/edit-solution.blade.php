   ...
   <div class="row gx-3">
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <form action="{{route('solutions.update',$whyChooseUs->id)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <!-- Row starts -->
                  <div class="row gx-3">
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-12">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="file" id="fileInput1" class="form-control file-input" name="side_image_top"  >
                           <span> ( Note:IMG TYPE:- JPEG,PNG,JPG,WEBP,SIZE:5MB )</span><br>
                           <a target="_blank" href="{{asset('assets/dynamics/'.$whyChooseUs->side_image_top)}}">
                              <img src="{{asset('assets/dynamics/'.$whyChooseUs->side_image_top)}}" style="width: 120px;height:80px;"></a>
                           <span id="messagefileInput1" class="text-danger"></span>
                           @error('side_image_top')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     </div>
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="file" id="fileInput2" class="form-control file-input" name="side_image_bottom"  >
                           <span> ( Note:IMG TYPE:- JPEG,PNG,JPG,WEBP,SIZE:5MB )</span><br>
                           <a target="_blank" href="{{asset('assets/dynamics/'.$whyChooseUs->side_image_bottom)}}">
                              <img src="{{asset('assets/dynamics/'.$whyChooseUs->side_image_bottom)}}" style="width: 120px;height:80px;"></a>
                           <span id="messagefileInput2" class="text-danger"></span>
                           @error('side_image_bottom')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     </div>
