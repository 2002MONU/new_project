            ...
            <div class="card-body">
               <form action="{{route('home-abouts.update',['home_about'=>$about->id])}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row gx-3">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Active Clients <span class="text-danger">*</span> </label>
                           <input type="text" class="form-control "   name="active_client" placeholder="Enter title " value="{{$about->active_client}}">
                           @error('active_client')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Electricity Services <span class="text-danger">*</span> </label>
                           <input type="text" class="form-control "   name="electricity_Services" placeholder="Enter electricity_Services " value="{{$about->electricity_Services}}">
                           @error('electricity_Services')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     </div>
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Team Advisors <span class="text-danger">*</span> </label>
                           <input type="text" class="form-control "   name="team_Advisors" placeholder="Enter team_Advisors " value="{{$about->team_Advisors}}">
                           @error('team_Advisors')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Years of Experienced <span class="text-danger">*</span> </label>
                           <input type="text" class="form-control "   name="years_of_Experienced" placeholder="Enter years_of_Experienced " value="{{$about->years_of_Experienced}}">
                           @error('years_of_Experienced')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     </div>
