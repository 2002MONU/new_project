...
<div class="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcumb-bg.jpg">
  <div class="container z-index-common">
    <div class="breadcumb-content">
      <h1 class="breadcumb-title">Field Crop Details</h1>
      <!-- <ul class="breadcumb-menu">
        <li><a href="index.html">Home</a></li>
        <li>Fields Crop Details</li>
      </ul> -->
    </div>
  </div>
</div>
...
<section class="row  about-product">
  <div class="col-lg-6 col-md-12 productroad" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
    <img src="images/fc4.png" alt="Product Image">
  </div>
      ...
      <div class="p-3 mb-3 text-center">
        <ul class="list-unstyled product-list">
          <li class="text-start">
            ...
            <span>Widely Adapted Hybrid with Outstanding Yield and Stability</span>
          </li >
          <li class="text-start">
            <img src="images/ar4.png" alt="No of monopodia">
            <span>Plant height - 180-210cm
            </span>
          </li>
          <li  class="text-start">
            <img src="images/ar4.png" alt="Days to Maturity">
            <span>Cob length - 20-22cm
            </span>
          </li>
          <li class="text-start">
            <img src="images/ar4.png" alt="Boll size">
            <span>Stable yielder across the environments good responsive to high input  management Excellent agronomics and Consistency.
            </span>
          </li>
          <li class="text-start">
            <img src="images/ar4.png" alt="Staple length">
            <span>Orange Yellow semi dent with bold kernels with excellent tip filling.
            </span>
          </li>
          <li class="text-start">
            <img src="images/ar4.png" alt="Leaf hairiness">
            <span>Table top in looking
            </span>
          </li>
        </ul>
      </div>
    ...
    <div class="row slider-shadow ot-carousel" id="serviceSlider1" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="2" data-focuson-select="false">
      <div class="col-sm-6 col-lg-4 ">
        <div class="card product-card field-crops">
          <a href="crop-details.php"><img src="images/m1.png" class="card-img-top" alt="Product Image"></a>
          <!-- <hr class="products-below"> -->
          <div class="card-body text-center">
            <a href="crop-details.php">
              <h5 class="card-title  ">Hybrid Maize</h5>
            </a>
      ...
      <div class="col-sm-6 col-lg-4 ">
        <div class="card product-card field-crops">
          <a href="crop-details.php"><img src="images/m2.png" class="card-img-top" alt="Product Image"></a>
          <!-- <hr class="products-below"> -->
          <div class="card-body text-center">
            <a href="crop-details.php">
              <h5 class="card-title  ">Hybrid Maize</h5>
      ...
      <div class="col-sm-6 col-lg-4 ">
        <div class="card product-card field-crops">
          <a href="crop-details.php"><img src="images/m3.png" class="card-img-top" alt="Product Image"></a>
          <!-- <hr class="products-below"> -->
          <div class="card-body text-center">
            <a href="crop-details.php">
              <h5 class="card-title  ">Hybrid Maize</h5>
      ...
      <div class="col-sm-6 col-lg-4 col-xl-3">
        <div class="card product-card field-crops">
          <a href="crop-details.php"><img src="images/m4.png" class="card-img-top" alt="Product Image"></a>
          <!-- <hr class="products-below"> -->
          <div class="card-body text-center">
            <a href="crop-details.php">
              <h5 class="card-title  ">Hybrid Maize</h5>
      ...
      <div class="col-sm-6 col-lg-4 ">
        <div class="card product-card field-crops">
          <a href="crop-details.php"><img src="images/m5.png" class="card-img-top" alt="Product Image"></a>
          <!-- <hr class="products-below"> -->
          <div class="card-body text-center">
            <a href="crop-details.php">
              <h5 class="card-title  ">Hybrid Maize</h5>
      ...
      <div class="col-sm-6 col-lg-4 ">
        <div class="card product-card field-crops">
          <a href="crop-details.php"><img src="images/m6.png" class="card-img-top" alt="Product Image"></a>
          <!-- <hr class="products-below"> -->
          <div class="card-body text-center">
            <a href="crop-details.php">
              <h5 class="card-title  ">Hybrid Maize</h5>
      ...
      <div class="col-sm-6 col-lg-4 ">
        <div class="card product-card field-crops">
          <a href="crop-details.php"><img src="images/m7.png" class="card-img-top" alt="Product Image"></a>
          <!-- <hr class="products-below"> -->
          <div class="card-body text-center">
            <a href="crop-details.php">
              <h5 class="card-title  ">Hybrid Maize</h5>
      ...
      <div class="col-sm-6 col-lg-4 ">
        <div class="card product-card field-crops">
          <a href="crop-details.php"><img src="images/m8.png" class="card-img-top" alt="Product Image"></a>
          <!-- <hr class="products-below"> -->
          <div class="card-body text-center">
            <a href="crop-details.php">
              <h5 class="card-title  ">Hybrid Maize</h5>
            </a>
            <!-- <p class="card-text  ">Hybrid Maize</p> -->
          </div>
        </div>
      </div>
    </div>
