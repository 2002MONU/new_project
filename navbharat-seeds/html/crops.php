  ...
  <div class="container">
    <div class="row justify-content-md-between justify-content-center align-items-end">
      ...
      <!-- <div class="col-auto">
        <div class="sec-btn">
          <div class="icon-box">
            <button data-slick-prev="field-crops.phpserviceSlider1" class="slick-arrow default">
              <i class="far fa-chevrons-left"></i>
            </button>
            <button data-slick-next="field-crops.phpserviceSlider1" class="slick-arrow default">
    ...
    <div class="row " id="serviceSlider1" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="2" data-focuson-select="false">
      <div class="col-sm-6 col-lg-4 col-xl-3 mb-3">
        <div class="service-card">
          <div class="box-img">
            <img src="images/castor.jpg" alt="service image" />
          </div>
          <div class="box-content">
            ...
            <div class="box-icon" data-bg-src="assets/img/icon/service_card_icon.svg">
              <img src="images/castor1.png" alt="Icon" />
            </div>
            <h3 class="box-title">
              <a href="field-crops.php">Hybrid Castor
              </a>
            </h3>
            <p class="box-text">
