...
@section('title') Edit Research @endsection
   ...
   <div class="row gx-3">
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <form action="{{ route('overviews.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <!-- Row starts -->
                  <div class="row gx-3">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <a href="{{ asset('assets/dynamics/' . $about->image) }}" target="_blank">
                               <img src="{{ asset('assets/dynamics/' . $about->image) }}" style="width:80px; height:80px; margin-right: 5px;">
                           </a>
                        </div>
                     </div>
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea class="form-control ckeditor" name="description_02" placeholder="Enter description">{{ $about->description_01 }}</textarea>
