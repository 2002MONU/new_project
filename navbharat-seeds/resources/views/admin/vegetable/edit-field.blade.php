        ...
        <div class="row gx-3">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('vegetable-crops.update',$fielddCrop->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <!-- Row starts -->
                              <div class="row gx-3">
                                 <div class=" col-xxl-6 col-lg-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="product_name"
                                            placeholder="Enter title " value="{{ $fielddCrop->product_name }}">
                                        @error('product_name')
                                 ...
                                 <div class="col-xxl-6 col-lg-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" name="title"
                                            placeholder="Enter title">{{ $fielddCrop->title }}</textarea>
                                        @error('title')
                                            <div class="error text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                 ...
                                 <div class="col-xxl-6 col-lg-6 col-sm-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="a2"> Icon <span
                                                class="text-danger">*</span></label>
                                        <input type="file" id="fileInput2" class="form-control file-input"
                                            name="icon" >
                                        <span> ( Note:IMG TYPE:- JPEG,PNG,JPG,)</span>
                                        <a  target="_blank" href="{{asset('assets/dynamics/'.$fielddCrop->icon)}}" target="_blank">
                                          <img src="{{asset('assets/dynamics/'.$fielddCrop->icon)}}" class="bg-dark" style="width:80px;height:80px;"></a>
                                ...
                                <div class="col-xxl-6 col-lg-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="priority"
                                            placeholder="Enter priority " value="{{ $fielddCrop->priority }}">
                                        @error('priority')
                                            <div class="error text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-6 col-lg-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="status" id="" class="form-control">
                                            ...
                                            <option value="1" {{$fielddCrop->status == 1 ? 'selected' : ''}}>Active</option>
                                            <option value="0" {{$fielddCrop->status == 0 ? 'selected' : ''}}>Inactive</option>
                                        </select>
                                        @error('status')
                                            <div class="error text-danger">{{ $message }}</div>
                                        @enderror
