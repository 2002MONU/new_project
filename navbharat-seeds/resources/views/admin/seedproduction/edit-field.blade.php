...
@section('title')
    Edit Seed Production & Processing Facilities
@endsection
        ...
        <div class="row gx-3">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('seed-productions.update',$fielddCrop->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <!-- Row starts -->
                              <div class="row gx-3">
                                ...
                                <div class="col-xxl-6 col-lg-6 col-sm-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="a2">Description <span
                                                class="text-danger">*</span> </label>
                                        <textarea type="text" class="form-control ckeditor" name="description" placeholder="Enter title ">{{ $fielddCrop->description }} </textarea>
                                        @error('description')
                                            <div class="error text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
