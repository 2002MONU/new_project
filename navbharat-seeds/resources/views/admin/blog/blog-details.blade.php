                  ...
                  <tbody>
                     @foreach ($blogs as $blog)
                       <tr>
                            ...
                            <td >{{ $blog->title }}</td>
                            <td >{{ $blog->postBy }}</td>
                            <td><a target="_blank" href="{{asset('assets/dynamics/'.$blog->main_image)}}" target="_blank">
                                <img src="{{asset('assets/dynamics/'.$blog->main_image)}}" style="width:80px;height:80px;"></a></td>
                            <td> {{ $blog->priority }}</td>
                            <td> @if ($blog->status == 1)
