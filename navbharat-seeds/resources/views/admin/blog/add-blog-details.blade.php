                  ...
                  <div class="row gx-3">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="postBy" placeholder="Enter post by " value="{{old('postBy')}}"> 
                           @error('postBy')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="thought_user" placeholder="Enter thought_user " value="{{old('thought_user')}}"> 
                           @error('thought_user')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control "   name="thought_title" placeholder="Enter thought_title " > {{old('thought_title')}}</textarea>
                           @error('thought_title')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-12 col-lg-12 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control ckeditor"   name="main_description" placeholder="Enter main_description " value=""> {{old('main_description')}}</textarea>
                      ...
                      <div class="col-xxl-12 col-lg-12 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control ckeditor"   name="description_02" placeholder="Enter description_02 " value=""> {{old('description_02')}}</textarea>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="title_01" placeholder="Enter title_01 " value="{{old('title_01')}}"> 
                           @error('title_01')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-12 col-lg-12 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control ckeditor"   name="description_03" placeholder="Enter description_03 " value=""> {{old('description_03')}}</textarea>
