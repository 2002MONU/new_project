...
<div class="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcumb-bg.jpg">
  <div class="container z-index-common">
    <div class="breadcumb-content">
      <h1 class="breadcumb-title">{{$seed->name}}</h1>
...
<section class="row  about-product">
  <div class="col-lg-6 col-md-12  productroad" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
    <img src="{{asset('assets/dynamics/'.$seed->product_image)}}" alt="Product Image">
  </div>
    ...
    <div class="row">
      <div class="col-md-6" data-aos="fade-up-right">
        <div class="brochure-card">
          <img src="{{asset('assets/dynamics/'.$seed->brocher_image_01)}}" alt="Brochure 1" onclick="openPopup(0)">
        </div>
      </div>
      <div class="col-md-6" data-aos="fade-up-left">
        <div class="brochure-card">
          <img src="{{asset('assets/dynamics/'.$seed->brocher_image_02)}}" alt="Brochure 2" onclick="openPopup(1)">
        </div>
      </div>
    </div>
    <div class="buttons-section"  data-aos="flip-left">
      <button class="brocher-download-button"><a target="_blank" href="{{asset('assets/dynamics/'.$seed->brocher_01)}}" download>
          Brocher Download
        </a></button>
      <button class="brocher-download-button"><a target="_blank" href="{{asset('assets/dynamics/'.$seed->brocher_02)}}" download>
          Brocher Download
        </a></button>
    </div>
  </div>
...
<script>
  ...
  const images = [
    '{{asset('assets/dynamics/'.$seed->brocher_image_01)}}',
    '{{asset('assets/dynamics/'.$seed->brocher_image_02)}}'
  ];
    ...
    <div class="row slider-shadow ot-carousel" id="serviceSlider1" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="2" data-focuson-select="false">
      ...
      <div class="card product-card">
          ...
          <div class="card-body text-center">
            <a href="{{route('website.cotton-seed-details',$seed->slug)}}"><h5 class="card-title  ">{{$seed->name}}</h5></a>
            <p class="card-text  ">{{$seed->type}}</p>
          </div>
        </div>
      </div>
      @endforeach
