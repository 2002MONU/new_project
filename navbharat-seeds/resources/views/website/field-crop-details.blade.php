...
@section('website')
    <div class="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcumb-bg.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">{{ $crop->name }}</h1>
    ...
    <section class="row  about-product">
        <div class="col-lg-6 col-md-12 productroad" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
            <img src="{{ asset('assets/dynamics/' . $crop->product_image) }}" alt="Product Image">
        </div>
            ...
            <div class="row">
                <div class="col-md-6" data-aos="fade-up-right">
                    <div class="brochure-card">
                        <img src="{{asset('assets/dynamics/'.$crop->brocher_image_01)}}" alt="Brochure 1" onclick="openPopup(0)">
                    </div>
                </div>
                <div class="col-md-6" data-aos="fade-up-left">
                    <div class="brochure-card">
                        <img src="{{asset('assets/dynamics/'.$crop->brocher_image_02)}}" alt="Brochure 2" onclick="openPopup(1)">
                    </div>
                </div>
            </div>
            <div class="buttons-section" data-aos="flip-left">
                <button class="brocher-download-button"><a href="{{asset('assets/dynamics/'.$crop->brocher_01)}}" download>
                        Brocher Download
                    </a></button>
                <button class="brocher-download-button"><a href="{{asset('assets/dynamics/'.$crop->brocher_02)}}" download>
                        Brocher Download
                    </a></button>
            </div>
        </div>
    ...
    <script>
        ...
        const images = [
            '{{asset('assets/dynamics/'.$crop->brocher_image_01)}}',
            '{{asset('assets/dynamics/'.$crop->brocher_image_01)}}'
        ];
    ...
    <section class="bg-smoke2 space" data-bg-src="assets/img/bg/service_bg_1.png">
        <div class="container">
            ...
            <div class="row slider-shadow ot-carousel" id="serviceSlider1" data-slide-show="4" data-lg-slide-show="3"
               ...
               @foreach ($fieldrelated as $related)
               <div class="col-sm-6 col-lg-4 ">
                   <div class="card product-card field-crops">
                       <a href="{{route('website.field-category',$related->slug)}}"><img src="{{asset('assets/dynamics/'.$related->image)}}" class="card-img-top" alt="Product Image"></a>
                       <!-- <hr class="products-below"> -->
                       <div class="card-body text-center">
                           <a href="{{route('website.field-category',$related->slug)}}">
