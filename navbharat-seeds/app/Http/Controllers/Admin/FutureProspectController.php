...
class FutureProspectController extends Controller
{
    /**
    ...
    {
        $about = FutureProspect::find($id);
        return view('admin.research.edit-future', compact('about'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $about->save();
        return redirect()->back()->with('success', 'Future Prospects details updated successfully');
    }
