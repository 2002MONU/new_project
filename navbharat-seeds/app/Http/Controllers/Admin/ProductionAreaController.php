...
class ProductionAreaController extends Controller
{
    ...
    {
        $about = ProductionArea::find($id);
        return view('admin.processing-plant.area',compact('about'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $about->save();
        return redirect()->back()->with('success', 'Production Areas  updated successfully');
    }
