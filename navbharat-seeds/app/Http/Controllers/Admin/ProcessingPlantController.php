...
class ProcessingPlantController extends Controller
{
    ...
    {
        $about = ProcessingPlant::find($id);
        return view('admin.processing-plant.novtable',compact('about'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $about->save();
        return redirect()->back()->with('success', 'Processing Plant updated successfully');
    }
